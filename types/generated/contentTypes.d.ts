...
export interface ApiHeaderHeader extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Logo, texto del logo y n\u00FAmero de WhatsApp del header';
    displayName: 'Header';
    pluralName: 'headers';
    singularName: 'header';
  };
  ...
  attributes: {
    ...
    logoTextEnd: Schema.Attribute.String & Schema.Attribute.Required;
    logoTextStart: Schema.Attribute.String & Schema.Attribute.Required;
...
export interface ApiHomeHome extends Struct.SingleTypeSchema {
  ...
  attributes: {
    center: Schema.Attribute.Component<'home.center', true> &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
        {
          max: 1;
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    heroSection: Schema.Attribute.Component<'home.hero-section', true> &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
        {
          max: 1;
...
export interface ApiMethodMethod extends Struct.SingleTypeSchema {
  collectionName: 'methods';
  info: {
    description: 'M\u00E9todo de trabajo con 4 pasos compartido por todos los servicios';
    displayName: 'Method';
    pluralName: 'methods';
    singularName: 'method';
  };
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    methodSteps: Schema.Attribute.Component<'service.method-step', true>;
    publishedAt: Schema.Attribute.DateTime;
    services: Schema.Attribute.Relation<'oneToMany', 'api::service.service'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiNavigationNavigation extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    items: Schema.Attribute.Component<'navigation.menu-group', true> &
      Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiServiceService extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    descriptionHtml: Schema.Attribute.Text;
    home: Schema.Attribute.Relation<'manyToOne', 'api::home.home'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    method: Schema.Attribute.Relation<'manyToOne', 'api::method.method'>;
    order: Schema.Attribute.Integer;
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'title'> & Schema.Attribute.Required;
    title: Schema.Attribute.String & Schema.Attribute.Required;
    titleImage: Schema.Attribute.Media<'images'>;
    treatments: Schema.Attribute.Component<'service.treatment', true>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
